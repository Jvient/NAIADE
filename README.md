...
================================================================================
  ...
  USAGE
  ─────
  # Entraînement PPO complet :
  python 03_rl.py --train

  # Entraînement + front de Pareto :
  python 03_rl.py --train --pareto

  # Front de Pareto seul (depuis checkpoint) :
  python 03_rl.py --pareto

  # GIF de progression seul :
  python 03_rl.py --gif

  # Tout :
  python 03_rl.py --train --pareto --gif
  ...
  --pareto               Calcule le front de Pareto (info vs N capteurs).
                         Sweep sur N ∈ [n_min−5, n_max+10] avec 30 configs
                         aléatoires par N. Identifie le coude (N★).
                         Produit rl_pareto_front.png, rl_two_configs.png.
...
================================================================================
  ...
  FIGURES — BRIQUE 3 (RL)
    ...
    rl_pareto_front.png           Front de Pareto info vs N capteurs
                                  (évalué avec la politique entraînée)
