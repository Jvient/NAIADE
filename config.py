...
GLORYS_DIR       = "data/raw/glorys_gascogne"
...
#   sous-échantillonnages du VAE (34→17→8→4→2). Préférer B.
...
#   (0, k) avec k autour de 20–50 m : « un réseau de surface contraint-il la
...
# Attention : sur une grille 48×48, MIN_BUOY_DIST=4 avec N_BUOYS=30 est déjà
